...
public class SessionUtil {
     ...
     * @param response
     */
    public static String createSession(Integer userId, HttpServletRequest request, HttpServletResponse response){
        String user_key_str = System.currentTimeMillis() + ":" + request.getRemoteAddr() + ":" + userId;
