        ...
        <ul class="forminfo">
            <li><label>所属目录<b class="mustfill">*</b></label>
                ...
                <#list categoryList as category>
                    <option value="${category.id}" <#if category.id == product.categoryId>selected="selected"</#if> >${category.name}</option>
                </#list>
                </select>
            </li>
            <li><label>产品名称<b class="mustfill">*</b></label><input id="name" name="name" type="text" class="dfinput" maxlength="30" value="${product.name}"/><i>标题不能超过30个字符</i></li>
            <li><label>价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格<b class="mustfill">*</b></label><input id="price" name="price" type="text" value="${product.price}" class="dfinput" maxlength="10" /><i>大于0元</i></li>
            <li><label>秒杀价格<b class="mustfill">*</b></label><input id="seckillPrice" name="price" type="text" value="${product.seckillPrice}" class="dfinput" maxlength="10" /><i>大于0元</i></li>
            <li><label>库&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;存<b class="mustfill">*</b></label><input id="stock" name="stock" type="text" value="${product.stock}" class="dfinput" maxlength="100"/><i>大于0</i></li>
            ...
            <li><label>图&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;片<b class="mustfill">*</b></label>
                ...
                <#list imageList as image>
                    <option value="${image.id}" <#if image.id = product.imageId>selected="selected"</#if> ><a>${image.name}</a></option>
                </#list>
                </select>
            </li>
            <li><label>详情描述<b class="mustfill">*</b></label><textarea id="detail" name="detail"  style="border: 1px solid gray;" rows="5" cols="100" maxlength="200">${product.detail}</textarea><i>最多200个字符</i></li>
