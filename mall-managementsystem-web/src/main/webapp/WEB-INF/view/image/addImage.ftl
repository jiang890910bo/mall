...
<div class="formbody">
    ...
    <ul class="forminfo">
        ...
        <li><label>名称</label><input id="name" type="text" name="imageName"  class="dfinput" maxlength="20"/></li>
        <li><label>图片</label><input id="file" type="file" name="imageFile" onchange="selectImage()" />    </li>
        <li><label>&nbsp;</label><img src="" id="showSmall" width="86" height="53">
        </li>
        <li><label>&nbsp;</label><img src="" id="showBig" width="568" height="348">
        </li>
...
<script type="application/javascript">
    ...
    function checkSubmit(){
        ...
        if(!not_null_regex.test(imageUrl)){
            $("#message").text("请选择图片");
            showTip();
            return false;
        }else{
