...
<div class="formbody">
    ...
    <ul class="forminfo">
        ...
        <li><label>目录名<b class="mustfill">*</b></label><input id="name" name="name" type="text" class="dfinput" maxlength="15" /><i>最多15个字符</i></li>
        <li><label>排序值</label><input id="sortOrder" name="sortOrder" type="text" value="999" class="dfinput" maxlength="5"/></li>
