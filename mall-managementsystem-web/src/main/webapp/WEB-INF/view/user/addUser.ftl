...
<div class="formbody">
    ...
    <ul class="forminfo">
        <li><label>登录名<b class="mustfill">*</b></label><input id="loginName" name="name" type="text" class="dfinput" maxlength="30" onblur="checkNameExist()"/><i>标题不能超过30个字符</i></li>
        <li><label>密&nbsp;&nbsp;&nbsp;码<b class="mustfill">*</b></label><input id="password" name="password" type="password" class="dfinput" maxlength="10" /><i>最少六个字符</i></li>
        <li><label>邮&nbsp;&nbsp;&nbsp;箱</label><input id="email" name="email" type="text" value="" class="dfinput" maxlength="100"/></li>
        <li><label>电&nbsp;&nbsp;&nbsp;话<b class="mustfill">*</b></label><input id="mobile" name="mobile" type="text" class="dfinput" maxlength="20"/></li>
        <li><label>角&nbsp;&nbsp;&nbsp;色</label>
        ...
        <li><label>找回密码的问题<b class="mustfill">*</b></label><input id="question" name="question" type="text" class="dfinput" maxlength="50"/></li>
        <li><label>找回密码的答案<b class="mustfill">*</b></label><input id="answer" name="answer" type="text" class="dfinput" maxlength="50"/></li>
...
<script type="application/javascript">
    ...
    //检查用户名是否存在
     function checkNameExist(){
        ...
        if(not_null_regex.test(loginName)){
            $.ajax({
                url:"/user/checkLoginNameExist",
                dateType:"json",
                type:"post",
                data:{userName:encodeURI(loginName)},
                success:function(res){
                    if(res.status == 0){
                        $("#message").text("抱歉，该名成已存在!");
                        showTip();
                    }
                },
                error:function(res){
